...
export const UI_STRINGS = {
  en: {
    ...
    accountBadgeHint: "tap to switch accounts",
    guestAccount: "Guest",
    switchAccount: "Switch account",
    switchAccountPin: "PIN for {name}",
    switchAddAccount: "Sign in…",
    switchedToGuest: "Signed out — Guest",
  ...
  ar: {
    ...
    chooseLanguage: "اختَر اللغة",
    chooseDialect: "اختَر اللهجة",
    voice: "الصوت",
    preview: "جرّب",
    settings: "الإعدادات",
    ...
    sendToBottom: "انقل للآخر",
    sentToBottom: "تم النقل للآخر",
    ...
    signedInAs: "مسجّل كـ",
    accountBadgeHint: "اضغط لتبديل الحسابات",
    guestAccount: "ضيف",
    switchAccount: "تبديل الحساب",
    switchAccountPin: "رمز PIN لـ {name}",
    switchAddAccount: "تسجيل الدخول…",
    switchedToGuest: "تم تسجيل الخروج — ضيف",
    switchingAccount: "جاري الدخول…",
