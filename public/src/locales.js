...
export const UI_STRINGS = {
  en: {
    ...
    kidHint: "Tap a picture to talk · hold to re-record",
    ...
    moreUnlocking: "No extra words beyond the home screen yet.",
    noTierMore: "No extra words yet — unlock more in settings.",
    pinToHome: "Add to main board",
    unpinFromHome: "Remove from main board",
  ...
  ar: {
    ...
    kidHint: "دوس على الصورة عشان تتكلم · اضغط مطوّلاً لإعادة التسجيل",
    ...
    moreUnlocking: "ما في كلمات إضافية غير الشاشة الرئيسية بعد.",
    noTierMore: "ما في كلمات إضافية بعد — افتح أكثر من الإعدادات.",
    pinToHome: "أضف للوحة الرئيسية",
    unpinFromHome: "أزل من اللوحة الرئيسية",
