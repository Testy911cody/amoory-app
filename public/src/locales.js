...
export const UI_STRINGS = {
  en: {
    ...
    moreUnlocking: "Every word is on the home screen — pin favorites from More words to keep them handy.",
  ...
  ar: {
    ...
    moreUnlocking: "كل الكلمات على الشاشة الرئيسية — ثبّت المفضلة من كلمات أكثر.",
