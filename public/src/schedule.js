...
let ctx = null;          // { getSettings, speakWord, wordsForCategory }
let slots = loadSlots(); // { first: wordSnapshot|null, then: wordSnapshot|null }
...
function renderPicker() {
  ...
  ctx.wordsForCategory(pickerCat).forEach(w => {
    ...
    card.onclick = () => {
      ...
      saveSlots();
      // auto-advance: after filling First, move to Then
